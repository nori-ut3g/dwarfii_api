 ...
 * @returns {Uint8Array}
 */
export function messageV3CameraParamSet(paramId: number, value: number, flag?: number): Uint8Array;
/**
 ...
 * @returns {Uint8Array}
 */
export function messageV3CameraParamSetExpGain(paramId: number, value: number, flag?: number): Uint8Array;
/**
 ...
 */
export function encodeParamId(shootingMode: number, category: number, cameraId: number, paramIndex: number): number;
/**
 ...
 */
export function decodeParamId(paramId: number): {
    shootingMode: number;
    category: number;
    cameraId: number;
    paramIndex: number;
